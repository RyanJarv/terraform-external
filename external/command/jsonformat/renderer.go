...
import (
	...
	"github.com/hashicorp/terraform/external/command/jsonformat/computed"
	"github.com/hashicorp/terraform/external/command/jsonformat/differ"
	"github.com/hashicorp/terraform/external/command/jsonformat/structured"
	"github.com/hashicorp/terraform/external/command/jsonplan"
	"github.com/hashicorp/terraform/external/command/jsonprovider"
	"github.com/hashicorp/terraform/external/command/jsonstate"
	viewsjson "github.com/hashicorp/terraform/external/command/views/json"
