...
import (
	...
	oauthserver "github.com/hashicorp/terraform/external/command/testdata/login-oauth-server"
	tfeserver "github.com/hashicorp/terraform/external/command/testdata/login-tfe-server"
