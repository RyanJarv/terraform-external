...
var protobufPkgs = map[string]string{
	"dependencies": "github.com/hashicorp/terraform/external/rpcapi/terraform1/dependencies",
	"stacks":       "github.com/hashicorp/terraform/external/rpcapi/terraform1/stacks",
	"packages":     "github.com/hashicorp/terraform/external/rpcapi/terraform1/packages",
}
