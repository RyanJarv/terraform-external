...
import (
	...
	"github.com/hashicorp/terraform/external/backend"
	"github.com/hashicorp/terraform/external/tfdiags"
	"github.com/zclconf/go-cty/cty"

	"github.com/hashicorp/terraform/external/backend/backendrun"
	backendLocal "github.com/hashicorp/terraform/external/backend/local"
	backendRemote "github.com/hashicorp/terraform/external/backend/remote"
	backendAzure "github.com/hashicorp/terraform/external/backend/remote-state/azure"
	backendConsul "github.com/hashicorp/terraform/external/backend/remote-state/consul"
	backendCos "github.com/hashicorp/terraform/external/backend/remote-state/cos"
	backendGCS "github.com/hashicorp/terraform/external/backend/remote-state/gcs"
	backendHTTP "github.com/hashicorp/terraform/external/backend/remote-state/http"
	backendInmem "github.com/hashicorp/terraform/external/backend/remote-state/inmem"
	backendKubernetes "github.com/hashicorp/terraform/external/backend/remote-state/kubernetes"
	backendOSS "github.com/hashicorp/terraform/external/backend/remote-state/oss"
	backendPg "github.com/hashicorp/terraform/external/backend/remote-state/pg"
	backendS3 "github.com/hashicorp/terraform/external/backend/remote-state/s3"
	backendCloud "github.com/hashicorp/terraform/external/cloud"
)
